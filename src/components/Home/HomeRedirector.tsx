...
import refer from '/assets/images/Home/refer-icon.png';
...
export function HomeRedirector() {
  ...
  const menuItems = [
    ...
    { icon: lock, path: '/', label: 'REFINEMENT', css: 'col-start-1 row-span-2 row-start-5 py-7 text-[#878787]' },
    { icon: shop, path: '/store', label: 'SHOP', css: 'col-start-2 row-span-4 row-start-3' },
    // { icon: lock, path: '/', label: 'LEADERBOARD', css: 'col-span-1 row-span-2 row-start-7 py-7 text-[#878787] ' },
    { icon: lb, path: '/leaderboard', label: 'LEADERBOARD', css: 'col-span-1 row-span-2 row-start-7 py-7' },
    { icon: refer, path: '/referral', label: 'EARN SHARDS', css: 'col-span-1 row-span-2 row-start-7 py-7' },
  ];

  return (
    <div className="grid-rows-8 mt-8 grid grid-cols-2 gap-4">
